...
.progress {
  ...
  .progress-bg {
    ...
    height: 4px;
    border-radius: 2px;
    background: -moz-linear-gradient(left, #2cbcfa 0%, rgba(0, 162, 255, 0.77) 10%, rgba(30, 146, 255, 0.8) 50%, #1194ff 70%, #078bff 100%);
    /* FF3.6-15 */
    background: -webkit-linear-gradient(left, #2cbcfa 0%, rgba(0, 162, 255, 0.77) 10%, rgba(30, 146, 255, 0.8) 50%, #1194ff 70%, #078bff 100%);
    /* Chrome10-25,Safari5.1-6 */
    background: linear-gradient(to right, #2cbcfa 0%, rgba(0, 162, 255, 0.77) 10%, rgba(30, 146, 255, 0.8) 50%, #1194ff 70%, #078bff 100%);
